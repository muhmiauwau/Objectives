...
## Fields Definition:
${JSON.stringify(helper.getDefaultTracker(trackerDef)) }
...
Changed fields?
Use the "Fields Definition" to identify changes.
...
`
*/
export const singleStepPrompt = `{{fieldPrompt}}

Default response: If the message contains relevant information, return the relevant data. If not, return false.
